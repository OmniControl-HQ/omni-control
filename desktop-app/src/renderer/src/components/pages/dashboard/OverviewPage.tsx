    ...
    <div className="flex flex-1 flex-col gap-3 overflow-hidden p-6">
      <GlassPanel className="flex flex-col gap-4 rounded-xl p-5">
        <div className="mb-2 flex items-end justify-between">
          <h2 className="text-[20px] font-medium leading-7 text-[#e2e2e4]">
            System Performance
          </h2>
          <span className="text-[12px] font-semibold leading-4 tracking-wider text-[#c4c7c7]">
        ...
        <div className="grid grid-cols-2 gap-6">
          <MetricBar
            icon="mode_fan"
            label="CPU Load"
            valueLabel={`${snapshot.cpuUsagePercent}%`}
          ...
          <MetricBar
            icon="memory"
            label="RAM Usage"
            valueLabel={`${formatBytes(snapshot.memoryUsedBytes)} / ${formatBytes(snapshot.memoryTotalBytes)}`}
      ...
      <GlassPanel className="flex min-h-0 flex-1 flex-col rounded-xl p-5">
        <div className="mb-4 flex shrink-0 items-center justify-between">
          ...
          <span className="rounded-full border border-white/5 bg-[#1e2021]/50 px-2 py-0.5 text-[12px] font-semibold leading-4 tracking-wider text-[#c4c7c7]">
