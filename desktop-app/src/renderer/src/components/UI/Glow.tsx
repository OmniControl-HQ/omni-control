...
const Glow = () => {
  const { glowRef, shadowOffset } = useGlow();
  ...
  return (
    <canvas
      ref={glowRef}
      className="absolute top-1/4 left-1/4 w-[600px] h-[600px] pointer-events-none -z-10 transition-transform duration-300 ease-out will-change-transform"
      style={{
